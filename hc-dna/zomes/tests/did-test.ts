...
orchestrator.registerScenario("create a profile and update it", async (s, t) => {
    ...
    //Test creating a profile with secp256k1
    let createProfile2 = await alice_profiles.cells[0].call(
        "did-profiles",
        "create_profile",
        {
          author: { did: 'did:key:zQ3shNgAH1yUW21P5se2jnkRW1PtoyaS8SrGRr8LBhLJw1SY7' },
          ...
          data: {
            '@context': {"foaf": "http://xmlns.com/foaf/0.1/"},
            profile: { 'foaf:AccountName': 'Alice2', '@type': 'foaf:OnlineAccount' },
            signed_agent: 'NA'
          },
          proof: {
            key: '#zQ3shNgAH1yUW21P5se2jnkRW1PtoyaS8SrGRr8LBhLJw1SY7',
    ...
    let getProfile2 = await alice_profiles.cells[0].call(
      "did-profiles",
      "get_profile",
      "did:key:zQ3shNgAH1yUW21P5se2jnkRW1PtoyaS8SrGRr8LBhLJw1SY7"
    );
